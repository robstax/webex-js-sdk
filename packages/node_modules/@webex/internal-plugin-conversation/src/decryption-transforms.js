 ...
 */
  ...
  decryptMeetingcontainer(ctx, key, meetingContainerActivity) {
    ...
    if (meetingContainerActivity.displayName && meetingContainerActivity.extensions) {
      promises.push(ctx.transform('decryptPropDisplayName', key, meetingContainerActivity));
    ...
    return Promise.resolve(meetingContainerActivity);
  },

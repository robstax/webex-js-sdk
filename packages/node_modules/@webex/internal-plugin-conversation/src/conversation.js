...
const Conversation = WebexPlugin.extend({
   ...
   * @property {string} object.displayName must be 'celebrate', 'heart', 'thumbsup', 'smiley', 'confused', 'sad'
   ...
   * create a reaction
   * @param {Object} conversation
   * @param {Object} displayName must be 'celebrate', 'heart', 'thumbsup', 'smiley', 'confused', 'sad'
   * @param {Object} parent activity object from convo we are reacting to
   * @returns {Promise<Activity>}
   */
  addReaction(conversation, displayName, parent) {
    return this.createReactionHmac(displayName, parent).then((hmac) => {

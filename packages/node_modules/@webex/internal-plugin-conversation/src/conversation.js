...
const Conversation = WebexPlugin.extend({
   ...
   * @param {Object} conversation
   * @param {Object} reactionPayload what we'll be sending to convo service to add or delete a reaction
   ...
   * @returns {Promise}
   */
  react(conversation, reactionPayload) {
    const url = this.getConvoUrl(conversation);
    const convoWithUrl = Object.assign({}, conversation, {url});

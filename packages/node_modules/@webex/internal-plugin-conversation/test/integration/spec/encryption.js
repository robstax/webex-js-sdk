...
describe('plugin-conversation', () => {
  ...
  describe('when interacting with a non-encrypted conversation', () => {
    ...
    describe('when the conversation is a grouped conversation', () => {
      ...
      describe('#react()', () => {
        it('reacts to message', () => webex.internal.conversation.post(conversation, {displayName: 'Ahoy'})
          .then((a) => webex.internal.conversation.react(conversation, {
          ...
          // this is crazy brittle. convo service "aggregates" reactions to other users on summary.
          // i've seen it take upwards of 30s for aggregation to happen and as little as <1s.

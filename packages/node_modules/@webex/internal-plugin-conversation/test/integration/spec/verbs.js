  ...
  describe('verbs', () => {
    ...
    describe('verbs that update objects', () => {
      ...
      describe('#react', () => {
        ...
        it('reacts and deletes a post', () => webex.internal.conversation.post(conversation, {displayName: 'React Me 1'})
          ...
          .then((c) => {
            ...
            return webex.internal.conversation.deleteReaction(conversation, reactionId);
          })
          .then(() => webex.internal.conversation.get(conversation, {
            activitiesLimit: 5,
            includeParticipants: true,

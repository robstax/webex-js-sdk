...
export default class RoapRequest extends StatelessWebexPlugin {
  ...
  sendRoap(options) {
    ...
    if (roapMessage && roapMessage.localSdp && roapMessage.localSdp.sdps && roapMessage.localSdp.sdps.indexOf('a=content:slides') === -1) {
      console.error('Content SDP not found in the SDp');
    }

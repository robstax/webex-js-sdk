...
skipInNode(describe)('plugin-meetings', () => {
  describe('journey', () => {
    ...
    describe('Successful 1:1 meeting (including Guest)', function () {
      ...
      it('alice shares the screen with constraints', () => alice.meeting.getMediaStreams({
        sendShare: true
      }, null, {highFrameRate: true})
        .then((response) => {
          assert.equal(response[1].getVideoTracks()[0].getConstraints().height, 720);
        }));
      ...
      it('alice shares the screen', () => alice.meeting.getMediaStreams({
        ...
        .then(() => {
          assert.equal(alice.meeting.mediaProperties.shareTrack.getConstraints().height, 1080);
